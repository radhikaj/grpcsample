...
class HelloInput : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:hello_world.HelloInput) */ {
 public:
  HelloInput();
  virtual ~HelloInput();
...
class HelloOutput : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:hello_world.HelloOutput) */ {
 public:
  HelloOutput();
  virtual ~HelloOutput();
...
class EnclaveInput : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:hello_world.EnclaveInput) */ {
 public:
  EnclaveInput();
...
class EnclaveOutput : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:hello_world.EnclaveOutput) */ {
 public:
  EnclaveOutput();
